...
import com.example.mobileapp.database.dao.DeletedHistoryDao;
...
@Database(entities = {LocalQuizQuestion.class, LocalTopic.class, DeletedHistory.class}, version = 3, exportSchema = false)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract DeletedHistoryDao deletedHistoryDao();
